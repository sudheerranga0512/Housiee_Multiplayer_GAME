...
class Ticket3 extends Component{
    constructor(props){
        super(props) 
        this.state={  
            id:1, 
            number :tambola.getTickets(3),
            number1:"Click  Btn",
            ...
            <div>   
                ...
                <tr>
                 ...
                 <td><button  id="9" onClick={this.change}>{ this.state.number[0][0][8] }</button></td>
                    ...
                    <tr>
                 <td><button onClick={this.change}> { this.state.number[0][1][0] }</button></td> 
                 <td><button onClick={this.change}> { this.state.number[0][1][1] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[0][1][2] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[0][1][3] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[0][1][4] }</button></td>
                 <td><button onClick={this.change}>{ this.state.number[0][1][5] }</button></td>
                 <td><button onClick={this.change}>{ this.state.number[0][1][6] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[0][1][7] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[0][1][8] }</button></td>

                    </tr>  
                
                    <tr>
                <td><button onClick={this.change}> { this.state.number[0][2][0] }</button></td> 
                <td><button onClick={this.change}> { this.state.number[0][2][1] }</button></td> 
                <td><button onClick={this.change}> { this.state.number[0][2][2] }</button></td> 
                <td><button onClick={this.change}> { this.state.number[0][2][3] }</button></td> 
                <td><button onClick={this.change}> { this.state.number[0][2][4] }</button></td>
                <td><button onClick={this.change}>{ this.state.number[0][2][5] }</button></td>
                <td><button onClick={this.change}> { this.state.number[0][2][6] }</button></td>
                <td><button onClick={this.change}> { this.state.number[0][2][7] }</button></td>
                <td><button onClick={this.change}> { this.state.number[0][2][8] }</button></td>
                    </tr> 
                    <tr>
                    <th colspan="9"><center>Ticket {this.state.id + 1}</center></th>
                </tr>
                    <tr>
                 <td><button onClick={this.change}> { this.state.number[1][0][0] }</button></td> 
                 <td><button onClick={this.change}> { this.state.number[1][0][1] }</button></td>
                 <td><button onClick={this.change}>{ this.state.number[1][0][2] }</button></td>
                 <td> <button onClick={this.change}>{ this.state.number[1][0][3] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[1][0][4] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[1][0][5] }</button></td>
                 <td><button onClick={this.change}>{ this.state.number[1][0][6] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[1][0][7] }</button></td>
                 <td><button onClick={this.change}>{ this.state.number[1][0][8] }</button></td>
                    </tr>  
                  
                    <tr>
                 <td><button onClick={this.change}> { this.state.number[1][1][0] }</button></td> 
                 <td><button onClick={this.change}> { this.state.number[1][1][1] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[1][1][2] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[1][1][3] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[1][1][4] }</button></td>
                 <td><button onClick={this.change}>{ this.state.number[1][1][5] }</button></td>
                 <td><button onClick={this.change}>{ this.state.number[1][1][6] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[1][1][7] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[1][1][8] }</button></td>

                    </tr>  
                
                    <tr>
                <td><button onClick={this.change}> { this.state.number[1][2][0] }</button></td> 
                <td><button onClick={this.change}> { this.state.number[1][2][1] }</button></td> 
                <td><button onClick={this.change}> { this.state.number[1][2][2] }</button></td> 
                <td><button onClick={this.change}> { this.state.number[1][2][3] }</button></td> 
                <td><button onClick={this.change}> { this.state.number[1][2][4] }</button></td>
                <td><button onClick={this.change}>{ this.state.number[1][2][5] }</button></td>
                <td><button onClick={this.change}> { this.state.number[1][2][6] }</button></td>
                <td><button onClick={this.change}> { this.state.number[1][2][7] }</button></td>
                <td><button onClick={this.change}> { this.state.number[1][2][8] }</button></td>
                    </tr>
                    <tr>
                    <th colspan="9"><center>Ticket {this.state.id + 2}</center></th>
                </tr>
                    <tr>
                 <td><button onClick={this.change}> { this.state.number[2][0][0] }</button></td> 
                 <td><button onClick={this.change}> { this.state.number[2][0][1] }</button></td>
                 <td><button onClick={this.change}>{ this.state.number[2][0][2] }</button></td>
                 <td> <button onClick={this.change}>{ this.state.number[2][0][3] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[2][0][4] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[2][0][5] }</button></td>
                 <td><button onClick={this.change}>{ this.state.number[2][0][6] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[2][0][7] }</button></td>
                 <td><button onClick={this.change}>{ this.state.number[2][0][8] }</button></td>
                    </tr>  
                  
                    <tr>
                 <td><button onClick={this.change}> { this.state.number[2][1][0] }</button></td> 
                 <td><button onClick={this.change}> { this.state.number[2][1][1] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[2][1][2] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[2][1][3] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[2][1][4] }</button></td>
                 <td><button onClick={this.change}>{ this.state.number[2][1][5] }</button></td>
                 <td><button onClick={this.change}>{ this.state.number[2][1][6] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[2][1][7] }</button></td>
                 <td><button onClick={this.change}> { this.state.number[2][1][8] }</button></td>

                    </tr>  
                
                    <tr>
                <td><button onClick={this.change}> { this.state.number[2][2][0] }</button></td> 
                <td><button onClick={this.change}> { this.state.number[2][2][1] }</button></td> 
                <td><button onClick={this.change}> { this.state.number[2][2][2] }</button></td> 
                <td><button onClick={this.change}> { this.state.number[2][2][3] }</button></td> 
                <td><button onClick={this.change}> { this.state.number[2][2][4] }</button></td>
                <td><button onClick={this.change}>{ this.state.number[2][2][5] }</button></td>
                <td><button onClick={this.change}> { this.state.number[2][2][6] }</button></td>
                <td><button onClick={this.change}> { this.state.number[2][2][7] }</button></td>
                <td><button onClick={this.change}> { this.state.number[2][2][8] }</button></td>
                    </tr>
